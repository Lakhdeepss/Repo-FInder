...
const LandingPage_view = () => {
    return (
        ...
        <div className='relative h-screen overflow-x-hidden'>
            ...
            <div className="absolute z-10 top-[32rem] w-screen h-[50vh] overflow-visible">
                <div
      ...
      `,
             ...
             lg:w-[220px] lg:h-[100px]"
                    ...
                    <div
                        ...
                        style={{
                            background: 'radial-gradient(ellipse at bottom, rgba(100,80,250,1) 70%, rgba(120,110,255,0.6) 85%, rgba(180,200,255,0.2) 100%)',
                        }}
                    ></div>
